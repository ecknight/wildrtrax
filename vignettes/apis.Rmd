...
Once authenticated, you can now use various functions that call upon the WildTrax APIs. For instance, you can use `wt_get_download_summary()` to see basic metadata about projects that you can download data for.  
