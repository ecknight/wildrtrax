...
```{r echo=F, eval=T, message=TRUE, include=TRUE}
knitr::opts_chunk$set(echo = TRUE)

load("camera.RData")
#save.image("camera.RData")
```
...
```{r, echo=TRUE, eval=T, message=TRUE, include=TRUE}
head(eh14_raw)
...
So there are **313** independent detections in this data set, when using a threshold of 30 minutes.
