...
Let's use some of the functins that are available to start cleaning up a dataset. For this question, we don't need certain abiotic and mammal codes so let's remove those with `wt_tidy_species()`,
...
Now you can calculate statistical offsets to account for imperfect detection following the [QPAD method](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.12106).
