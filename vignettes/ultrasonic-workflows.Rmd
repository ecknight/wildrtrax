...
from [Songscope](https://answers.wildlifeacoustics.com/) and [Kaleidoscope](https://www.wildlifeacoustics.com/products/kaleidoscope-pro) , \code`wt_songscope_tags()` and \code`wt_kaleidoscope_tags()`
